<?$this->load->view('header')?>
    <div id="main" role="main">
		...
		<div id="left-col">
			<?$this->load->view('deals/viewPartial', array('deal'=>$deal, 'header' => "Featured Deal"))?>
			<?$this->load->view('deals/otherdeals',array('header'=>'This week\'s deals','deals'=>$deals,'exclude'=>$deal->id))?>	
		</div><!-- /left-col -->
