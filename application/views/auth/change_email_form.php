...
<div id="header" class="wrapper">
    <div class="logo"><a href="/eves/" title=""><img src="<?= site_url('public/images/loginLogo.png')?>" alt="" /></a></div>
    <div class="middleNav">
...
<div class="wrapper">
	...
	<div class="widget">
	    ...
	    <div class="head"><h5 class="iImage2">Change Email</h5></div>
	    	...
	    	<?=form_open($this->uri->uri_string(),array('class'=>'mainForm'))?>
				<fieldset>
					...
					<?=form_submit('submit','Change Email','class="greyishBtn submitForm"')?>
 				</fieldset>
			<?=form_close()?>
